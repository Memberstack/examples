  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center">
        <div
          className="w-full h-full relative py-4"
          style={{ maxWidth: "60%" }}
        >
          <Image
            src={logo}
        ...
        <h1 className="h1 text-slate-200">
          <span className="block lg:inline">Memberstack</span>
          <span className="block text-sky-400 lg:inline"> 2.0</span>
        </h1>
        <p className="p mx-auto text-slate-400">
          To get started with the demo, sign up below 🚀
        </p>
        <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
          {isLoggedIn ? (
            <button
              className="btn btn-primary p-4 w-full"
